...
"""Verify that starting DeepOnion with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start DeepOnion with -h for help text")
        ...
        self.log.info("Start DeepOnion with -version for version information")
        ...
        self.log.info("Start DeepOniond with -fakearg to make sure it does not start")
