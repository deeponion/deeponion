...
* DeepOnion.conf: contains configuration settings for DeepOniond or DeepOnion-Qt
* DeepOniond.pid: stores the process id of DeepOniond while running
...
* debug.log: contains debug information and general logging generated by DeepOniond or DeepOnion-Qt
