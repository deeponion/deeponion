    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QSize splashSize(800*devicePixelRatio,505*devicePixelRatio);
    ...
    // draw the bitcoin icon, expected size of PNG: 800x505
    QRect rectIcon(QPoint(0,0), QSize(800,505));

    const QSize requiredSize(800,505);
    ...
    QFont vFont = QFont(font, 17*fontFactor);
    vFont.setWeight(QFont::Bold);
    pixPaint.setFont(vFont);
...
void SplashScreen::subscribeToCoreSignals()
{
    ...
    uiInterface.ShowProgressNoResume.connect(boost::bind(ShowProgressNoResume, this, boost::placeholders::_1, boost::placeholders::_2));
#ifdef ENABLE_WALLET
...
void SplashScreen::unsubscribeFromCoreSignals()
{
    ...
    uiInterface.ShowProgressNoResume.disconnect(boost::bind(ShowProgressNoResume, this, boost::placeholders::_1, boost::placeholders::_2));
#ifdef ENABLE_WALLET
