...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s DeepOnion-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  DeepOnion-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded DeepOnion transaction") + "\n" +
              "  DeepOnion-tx [options] -create [commands]   " + _("Create hex-encoded DeepOnion transaction") + "\n" +
              "\n";
